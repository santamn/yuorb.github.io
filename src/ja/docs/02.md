...
形態音韻論とは、ある言語がその音素（意味の区別に関わる音）や音韻論的特徴（音節強勢、重長音、声調など）を用いて、語形成や語に適用される形態論的なカテゴリー（単数と複数の区別や動詞の時制など）のパターンを生成する仕組みのことである。

::: info 品詞

新イスクイルには、**形成詞**、**付属詞**、**参照詞**という3種類の語が存在します。形成詞は、自然言語における名詞と動詞の両方に概ね相当する語のクラスを構成します。（[第2.4.2節](02#Sec2_4_2)では、新イスクイルの文法において名詞と動詞を1つの語種に統合することがなぜ理にかなっているのかについて解説しています。）付属詞は”補助”として働く語であり、隣接する形成詞と組み合わさることで、その形成詞についてさらなる意味論的な情報を提供する役割を担います。参照詞は、自然言語における代名詞と似た働きをする語の一種ですが、他の言語一般的に使われる代名詞よりもその用途はより動的で広範にわたるものであることを後ほど確認していきます。
