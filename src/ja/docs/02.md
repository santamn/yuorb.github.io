...
新イスクイルは主に膠着語であり、副次的に総合的言語としての性質を持つ言語です。これはつまり、形態意味語幹、屈折、および派生が形成される過程や、それらの要素が組み合わさって意味を持つ単語を構成する仕組みが、主に「意味語根に1つ以上の接辞（接頭辞、接尾辞、接中辞を含む）を結合させること」によって成り立っていることを意味しています。なお、その接辞自体は非常に総合的、すなわち、多数の形態論的カテゴリーが単一の音韻形式の中に凝縮されたものとなっています。要するに、新イスクイルの単語は中心となる語幹に複数の接辞を結合させることで形成され、それぞれの接辞には複数の意味要素が詰め込まれている、ということなのです。

:::

## 2.1 標準母音形配列 {#Sec2_1}

新イスクイルの単語構造を詳しく見ていくと、単語構造は一連の連続する”槽”によって構成されており、それらに接辞が当てはめられることで機能していることがわかります。そして、その槽を埋める構成要素である接辞の多くは、9つの母音からなる頻出パターンを含んでいるか、あるいは複数のパラメーターからなる表形式の派生パターンを有しており、その表の軸の一方に9つの母音からなるパターンが割り当てられています。そのため、この言語は複数の系列において9つの母音形式からなる標準的な汎用パターンが用いられ、これをさまざまな槽に割り当てていくことができます。この母音の標準的な汎用パターンは、この言語の習得を志す人々にとって、膨大な数の接辞を暗記する助けとなるのはずです。

下の表は、この「標準母音形配列」における様々なパターンを示したものです。新イスクイルの語形成で用いられる、形態変化を担う様々な槽を調べる際には、この表がとても役に立つでしょう。母音形式は数多くありますが、注意深く分析してみれば、その配列構造はかなり体系的であることが見て取れると思います。
