...
新イスクイルの単語構造を詳しく見ていくと、それが一連の連続する<ruby>”槽”<rt>　そう　</rt></ruby>によって構成されており、各槽に接辞が当てはめられることで機能していることがわかります。そして、その槽を埋める構成要素である接辞の多くは、9つの母音による頻出の変化パターンを含んでいるか、あるいは複数のパラメーターからなる表形式の派生パターンを有しており、その表の軸の一方に9つの母音からなるパターンが割り当てられています。このような背景から、この言語では、複数の系列において9つの母音形式からなる標準的な汎用パターンが採用されており、これをさまざまな槽に割り当てていくことで単語を形成することができます。この母音の標準的な汎用パターンは、この言語の習得を志す人々にとって、膨大な数の接辞を暗記する際の助けとなるでしょう。

下の表は、この「標準母音形配列」における様々なパターンを示したものです。新イスクイルの語形成で用いられる、形態変化を担う様々な槽について調べる際に、この表がとても役に立つでしょう。母音形式は数多くありますが、注意深く分析してみれば、その配列構造はかなり体系的であることが見て取れると思います。
